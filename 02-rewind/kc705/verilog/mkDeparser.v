...
//
// On Sat Jun  3 22:33:24 CST 2017
//
...
module mkDeparser(CLK,
  ...
  reg [1477 : 0] rg_metadata;
  wire [1477 : 0] rg_metadata_D_IN;
  wire rg_metadata_EN;
  ...
  wire [1745 : 0] stage2_ff_D_IN, stage2_ff_D_OUT;
  ...
  reg [63 : 0] v___1__h7455,
	       v___1__h7656,
	       v__h7688,
	       v__h7929,
	       v__h7989,
	       v__h8225;
  wire [15 : 0] mask_out__h8040, mask_out__h8456, x__h8279, x__h8533;
  wire [9 : 0] n_beat__h7602;
  ...
  // submodule stage2_ff
  FIFO2 #(.width(32'd1746), .guarded(32'd1)) stage2_ff(.RST(RST_N),
						       .CLK(CLK),
						       .D_IN(stage2_ff_D_IN),
						       .ENQ(stage2_ff_ENQ),
						       .DEQ(stage2_ff_DEQ),
  ...
  assign MUX_data_out_ff_enq_1__VAL_3 =
	     { 32'd0, rg_stage3[127:0], mask_out__h8040, rg_sop, 1'd0 } ;
  assign MUX_data_out_ff_enq_1__VAL_4 =
	     { 32'd0, rg_tmp[127:0], mask_out__h8456, 2'd0 } ;
  ...
  assign mask_out__h8040 = ~x__h8279 ;
  assign mask_out__h8456 = ~x__h8533 ;
  assign n_beat__h7602 = { 7'd0, stage3_ff_D_OUT[9:7] } ;
  assign x__h8279 = 16'd65535 << rg_processed[7:3] ;
  assign x__h8533 = 16'd65535 << rg_shift_amt[7:3] ;
  ...
  begin
	...
	rg_metadata <= `BSV_ASSIGNMENT_DELAY
	    1478';
  ...
  begin
    ...
    rg_eop = 1'h0;
    rg_metadata =
	1478';
  ...
  begin
	...
	$display("(%0d) stage2 %h len=%d",
		 v___1__h7455,
		 stage2_ff_D_OUT[1743:1488],
		 stage2_ff_D_OUT[1487:1478]);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont) $write("(%0d) stage3 cont ", v__h7929);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont)
