...
//
// On Sat Jun  3 22:32:17 CST 2017
//
...
module mkHostChannel(CLK,
  ...
  wire [1498 : 0] outReqFifo_D_IN, outReqFifo_D_OUT;
  wire outReqFifo_CLR,
       outReqFifo_DEQ,
       outReqFifo_EMPTY_N,
       outReqFifo_ENQ,
  ...
  FIFO2 #(.width(32'd1499), .guarded(32'd1)) outReqFifo(.RST(RST_N),
							.CLK(CLK),
