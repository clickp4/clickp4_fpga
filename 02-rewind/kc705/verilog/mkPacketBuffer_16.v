...
//
// On Sat Jun  3 22:18:47 CST 2017
//
...
// readServer_readData_get        O   178 reg
...
module mkPacketBuffer_16(CLK,
  ...
  output [177 : 0] readServer_readData_get;
  ...
  wire [255 : 0] dbg;
  wire [177 : 0] readServer_readData_get;
  ...
  // inlined wires
  wire [177 : 0] memBuffer_serverAdapterB_outData_outData_wget;
  ...
  wire [177 : 0] fifoReadData_D_IN, fifoReadData_D_OUT;
  ...
  wire [177 : 0] fifoWriteData_D_IN, fifoWriteData_D_OUT;
  ...
  wire [185 : 0] incomingReqs_D_IN, incomingReqs_D_OUT;
  ...
  wire [177 : 0] memBuffer_memory_DIA,
  ...
  wire [177 : 0] memBuffer_serverAdapterA_outDataCore_D_IN;
  ...
  wire [177 : 0] memBuffer_serverAdapterB_outDataCore_D_IN,
  ...
  wire [1 : 0] ab__h4227;
  wire memBuffer_serverAdapterA_cnt_6_SLT_3___d195,
       memBuffer_serverAdapterB_cnt_1_SLT_3___d221;
  ...
  FIFO2 #(.width(32'd178), .guarded(32'd1)) fifoReadData(.RST(RST_N),
							 .CLK(CLK),
  ...
  FIFO2 #(.width(32'd178), .guarded(32'd1)) fifoWriteData(.RST(RST_N),
							  .CLK(CLK),
  ...
  FIFO2 #(.width(32'd186), .guarded(32'd1)) incomingReqs(.RST(RST_N),
							 .CLK(CLK),
  ...
  assign WILL_FIRE_RL_enqueue_first_beat =
	     incomingReqs_EMPTY_N &&
	     memBuffer_serverAdapterA_cnt_6_SLT_3___d195 &&
	     !fifoEop_EMPTY_N &&
	     !inPacket ;
  ...
  // submodule fifoEop
  assign fifoEop_D_IN = packetLen + { 11'd0, x__h5286 } ;
  ...
  // submodule memBuffer_memory
  assign memBuffer_memory_ADDRA = incomingReqs_D_OUT[185:178] ;
  assign memBuffer_memory_ADDRB = rdCurrPtr ;
  assign memBuffer_memory_DIA = incomingReqs_D_OUT[177:0] ;
  ...
  assign memBuffer_serverAdapterA_cnt_6_SLT_3___d195 =
  ...
  assign memBuffer_serverAdapterB_cnt_1_SLT_3___d221 =
	     (memBuffer_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign newPacketLen__h5197 = packetLen + { 11'd0, x__h5286 } ;
  ...
  assign x__h5469 = { 4'd0, fifoWriteData_D_OUT[17] } ;
  assign y__h5302 = { 4'd0, fifoWriteData_D_OUT[2] } ;
  assign y__h5314 = { 4'd0, fifoWriteData_D_OUT[3] } ;
  assign y__h5326 = { 4'd0, fifoWriteData_D_OUT[4] } ;
  assign y__h5338 = { 4'd0, fifoWriteData_D_OUT[5] } ;
  assign y__h5350 = { 4'd0, fifoWriteData_D_OUT[6] } ;
  assign y__h5362 = { 4'd0, fifoWriteData_D_OUT[7] } ;
  assign y__h5374 = { 4'd0, fifoWriteData_D_OUT[8] } ;
  assign y__h5386 = { 4'd0, fifoWriteData_D_OUT[9] } ;
  assign y__h5398 = { 4'd0, fifoWriteData_D_OUT[10] } ;
  assign y__h5410 = { 4'd0, fifoWriteData_D_OUT[11] } ;
  assign y__h5422 = { 4'd0, fifoWriteData_D_OUT[12] } ;
  assign y__h5434 = { 4'd0, fifoWriteData_D_OUT[13] } ;
  assign y__h5446 = { 4'd0, fifoWriteData_D_OUT[14] } ;
  assign y__h5458 = { 4'd0, fifoWriteData_D_OUT[15] } ;
  assign y__h5470 = { 4'd0, fifoWriteData_D_OUT[16] } ;
