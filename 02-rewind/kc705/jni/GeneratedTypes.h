...
typedef struct PipelineRewindRewindTableReqT {
    uint8_t padding : 5;
    uint32_t click_id : 32;
    uint8_t click_state : 8;
} PipelineRewindRewindTableReqT;
typedef struct PipelineRewindRewindTableRspT {
    uint8_t _action : 1;
    uint8_t _state : 8;
    uint64_t _bitmap : 64;
} PipelineRewindRewindTableRspT;
...
} MainRequest_pipeline_rewind_rewind_table_add_entryData;
typedef union {
    ...
    MainRequest_pipeline_rewind_rewind_table_add_entryData pipeline_rewind_rewind_table_add_entry;
} MainRequestData;
...
typedef struct {
    ...
    int (*pipeline_rewind_rewind_table_add_entry) (  struct PortalInternal *p, const PipelineRewindRewindTableReqT key, const PipelineRewindRewindTableRspT val );
} MainRequestCb;
...
int MainRequestJson_pipeline_rewind_rewind_table_add_entry ( struct PortalInternal *p, const PipelineRewindRewindTableReqT key, const PipelineRewindRewindTableRspT val );
