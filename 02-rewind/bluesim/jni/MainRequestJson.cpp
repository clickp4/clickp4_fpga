...
{
    Json::Value request;
    request.append(Json::Value("pipeline_rewind_rewind_table_add_entry"));
    Json::Value _keyValue;
    _keyValue["__type__"]="PipelineRewindRewindTableReqT";
    _keyValue["padding"] = (Json::UInt64)key.padding;
    _keyValue["click_id"] = (Json::UInt64)key.click_id;
    _keyValue["click_state"] = (Json::UInt64)key.click_state;
    request.append(_keyValue);
    Json::Value _valValue;
    _valValue["__type__"]="PipelineRewindRewindTableRspT";
    ...
    std::string requestjson = Json::FastWriter().write(request);;
    connectalJsonSend(p, requestjson.c_str(), (int)CHAN_NUM_MainRequest_pipeline_rewind_rewind_table_add_entry);
    return 0;
};
...
MainRequestCb MainRequestJsonProxyReq = {
    ...
    MainRequestJson_pipeline_rewind_rewind_table_add_entry,
};
...
int MainRequestJson_handleMessage(struct PortalInternal *p, unsigned int channel, int messageFd)
{
    ...
    case CHAN_NUM_MainRequest_pipeline_rewind_rewind_table_add_entry: {
        ((MainRequestCb *)p->cb)->pipeline_rewind_rewind_table_add_entry(p, tempdata.pipeline_rewind_rewind_table_add_entry.key, tempdata.pipeline_rewind_rewind_table_add_entry.val);
      } break;
    default:
