...
int MainRequestpipeline_rewind_rewind_table_add_entry_cb (  struct PortalInternal *p, const PipelineRewindRewindTableReqT key, const PipelineRewindRewindTableRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->pipeline_rewind_rewind_table_add_entry ( key, val);
    return 0;
};
MainRequestCb MainRequest_cbTable = {
    ...
    MainRequestpipeline_rewind_rewind_table_add_entry_cb,
};
