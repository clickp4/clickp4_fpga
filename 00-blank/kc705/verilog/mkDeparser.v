...
//
// On Sun Jun  4 10:03:04 CST 2017
//
...
module mkDeparser(CLK,
  ...
  reg [1435 : 0] rg_metadata;
  wire [1435 : 0] rg_metadata_D_IN;
  wire rg_metadata_EN;
  ...
  wire [1703 : 0] stage2_ff_D_IN, stage2_ff_D_OUT;
  ...
  reg [63 : 0] v___1__h7237,
	       v___1__h7438,
	       v__h7470,
	       v__h7711,
	       v__h7771,
	       v__h8007;
  wire [15 : 0] mask_out__h7822, mask_out__h8238, x__h8061, x__h8315;
  wire [9 : 0] n_beat__h7384;
  ...
  // submodule stage2_ff
  FIFO2 #(.width(32'd1704), .guarded(32'd1)) stage2_ff(.RST(RST_N),
						       .CLK(CLK),
						       .D_IN(stage2_ff_D_IN),
						       .ENQ(stage2_ff_ENQ),
						       .DEQ(stage2_ff_DEQ),
  ...
  assign MUX_data_out_ff_enq_1__VAL_3 =
	     { 32'd0, rg_stage3[127:0], mask_out__h7822, rg_sop, 1'd0 } ;
  assign MUX_data_out_ff_enq_1__VAL_4 =
	     { 32'd0, rg_tmp[127:0], mask_out__h8238, 2'd0 } ;
  ...
  assign mask_out__h7822 = ~x__h8061 ;
  assign mask_out__h8238 = ~x__h8315 ;
  assign n_beat__h7384 = { 7'd0, stage3_ff_D_OUT[9:7] } ;
  assign x__h8061 = 16'd65535 << rg_processed[7:3] ;
  assign x__h8315 = 16'd65535 << rg_shift_amt[7:3] ;
  ...
  begin
	...
	rg_metadata <= `BSV_ASSIGNMENT_DELAY
	    1436';
  ...
  begin
    ...
    rg_eop = 1'h0;
    rg_metadata =
	1436';
  ...
  begin
	...
	$display("(%0d) stage2 %h len=%d",
		 v___1__h7237,
		 stage2_ff_D_OUT[1701:1446],
		 stage2_ff_D_OUT[1445:1436]);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont) $write("(%0d) stage3 cont ", v__h7711);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont)
