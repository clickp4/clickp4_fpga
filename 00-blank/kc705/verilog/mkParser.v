...
//
// On Sat Jun  3 16:16:50 CST 2017
//
...
module mkParser(CLK,
  ...
  wire [1435 : 0] meta_in_ff_D_IN, meta_in_ff_D_OUT;
  wire meta_in_ff_CLR,
       meta_in_ff_DEQ,
       meta_in_ff_EMPTY_N,
       meta_in_ff_ENQ,
  ...
  wire [511 : 0] v__h18993, v__h19067, x__h19166, x__h19169;
  wire [47 : 0] x__h40259, x__h42684;
  wire [31 : 0] x__h25171, x__h25175, x__h38806, x__h38810;
  wire [19 : 0] ipv6_flow_label__h26464;
  wire [15 : 0] ethernet_eth_type__h40267,
		ipv6_payload_len__h26465,
		x__h20746,
		x__h21720,
		x__h25190,
		x__h25194,
		...
		x__h38780,
		x__h38802;
  wire [12 : 0] ipv4_frag_offset__h35342;
  wire [9 : 0] x_port1__read__h14811, x_port1__read__h14827;
  wire [7 : 0] x__h33254;
  ...
  FIFO2 #(.width(32'd1436), .guarded(32'd1)) meta_in_ff(.RST(RST_N),
							.CLK(CLK),
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept =
	     WILL_FIRE_RL_fsmrl_rl_extract_2 && v__h18993[55:48] != 8'd17 ;
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept_1 =
	     WILL_FIRE_RL_fsmrl_rl_extract_3 && v__h18993[79:72] != 8'd6 &&
	     v__h18993[79:72] != 8'd17 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept ;
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept_2 =
	     WILL_FIRE_RL_fsmrl_rl_extract_4 &&
	     ethernet_eth_type__h40267 != 16'd2048 &&
	     ethernet_eth_type__h40267 != 16'd34525 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept_1 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept ;
  ...
  assign ethernet_out_ff_x_wire_wget =
	     { 4'd9, x__h40259, x__h42684, ethernet_eth_type__h40267 } ;
  ...
  assign w_parse_ipv4_parse_udp_whas =
	     WILL_FIRE_RL_fsmrl_rl_extract_3 && v__h18993[79:72] == 8'd17 ;
  ...
  assign rg_buffered_port2__read =
	     WILL_FIRE_RL_rl_start_state_deq ? 10'd0 : x_port1__read__h14811 ;
  ...
  assign data_in_tmp_EN_port1__write =
	     WILL_FIRE_RL_rl_start_state_deq ||
	     !parse_done_port1__read &&
	     x_port1__read__h14811 < x_port1__read__h14827 &&
	     w_parse_header_done_whas ;
  ...
  // register rg_next_header_len
  assign rg_next_header_len_D_IN = x_port1__read__h14827 ;
  ...
  // register rg_tmp
  assign rg_tmp_D_IN =
	     WILL_FIRE_RL_rl_accept ? MUX_rg_tmp_write_1__VAL_1 : v__h18993 ;
  assign rg_tmp_EN =
  ...
  assign ethernet_eth_type__h40267 =
	     { v__h18993[103:96], v__h18993[111:104] } ;
  assign ethernet_out_ff_cntr_r_8_MINUS_1___d55 =
	     ethernet_out_ff_cntr_r - 2'd1 ;
  assign ipv4_frag_offset__h35342 = { v__h18993[52:48], v__h18993[63:56] } ;
  assign ipv4_out_ff_cntr_r_9_MINUS_1___d86 = ipv4_out_ff_cntr_r - 2'd1 ;
  assign ipv6_flow_label__h26464 =
	     { v__h18993[11:8], v__h18993[23:16], v__h18993[31:24] } ;
  assign ipv6_out_ff_cntr_r_00_MINUS_1___d117 = ipv6_out_ff_cntr_r - 2'd1 ;
  assign ipv6_payload_len__h26465 = { v__h18993[39:32], v__h18993[47:40] } ;
  ...
  assign v__h18993 = data_in_tmp ? v__h19067 : rg_tmp ;
  assign v__h19067 = x__h19166 | rg_tmp ;
  assign x__h19166 = x__h19169 << rg_buffered ;
  assign x__h19169 = { 384'd0, data_in_ff_D_OUT[145:18] } ;
  assign x__h20746 = { v__h18993[55:48], v__h18993[63:56] } ;
  assign x__h21720 = { v__h18993[7:0], v__h18993[15:8] } ;
  assign x__h25171 =
	     { ipv6_payload_len__h26465,
	       v__h18993[55:48],
	       v__h18993[63:56] } ;
  assign x__h25175 =
	     { v__h18993[71:64],
	       ...
	       v__h18993[87:80],
	       v__h18993[95:88] } ;
  assign x__h25190 = { v__h18993[119:112], v__h18993[127:120] } ;
  assign x__h25194 = { v__h18993[135:128], v__h18993[143:136] } ;
  assign x__h25198 = { v__h18993[151:144], v__h18993[159:152] } ;
  assign x__h33254 = { v__h18993[3:0], v__h18993[15:12] } ;
  assign x__h38780 = { v__h18993[23:16], v__h18993[31:24] } ;
  assign x__h38802 = { v__h18993[87:80], v__h18993[95:88] } ;
  assign x__h38806 =
	     { ethernet_eth_type__h40267,
	       v__h18993[119:112],
	       v__h18993[127:120] } ;
  assign x__h38810 = { x__h25194, v__h18993[151:144], v__h18993[159:152] } ;
  assign x__h40259 =
	     { x__h21720,
	       v__h18993[23:16],
	       v__h18993[31:24],
  ...
  assign x__h42684 =
	     { x__h20746,
	       ...
	       v__h18993[87:80],
	       v__h18993[95:88] } ;
  assign x_port1__read__h14811 =
	     rg_buffered_EN_port0__write ?
	       rg_buffered_port0__write_1 :
	       rg_buffered ;
  assign x_port1__read__h14827 =
