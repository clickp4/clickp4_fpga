...
//
// On Sun Jun  4 10:04:49 CST 2017
//
...
module mkMetaGenChannel(CLK,
  ...
  wire [1456 : 0] host_outReqFifo_D_IN, host_outReqFifo_D_OUT;
  ...
  wire [1435 : 0] host_parser_meta_get;
  ...
  wire [1456 : 0] meta_in_ff_D_IN, meta_in_ff_D_OUT;
  wire meta_in_ff_CLR,
       meta_in_ff_DEQ,
       meta_in_ff_EMPTY_N,
       meta_in_ff_ENQ,
  ...
  wire [1456 : 0] meta_out_ff_D_IN, meta_out_ff_D_OUT;
  ...
  reg [63 : 0] v__h11302, v__h14383, v__h14513;
  wire [19 : 0] x__h8337;
  wire freq_cnt_46_ULT_rg_gap_47___d248;
  ...
  FIFO2 #(.width(32'd1457), .guarded(32'd1)) host_outReqFifo(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd1457), .guarded(32'd1)) meta_in_ff(.RST(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd1457), .guarded(32'd1)) meta_out_ff(.RST(RST_N),
							 .CLK(CLK),
  ...
  assign MUX_freq_cnt_write_1__VAL_2 =
	     freq_cnt_46_ULT_rg_gap_47___d248 ? x__h8337 : 20'd0 ;
  assign MUX_rg_iter_write_1__VAL_3 = rg_iter - 20'd1 ;

  // inlined wires
  assign w_send_meta_whas =
	     WILL_FIRE_RL_rl_freq_ctrl && !freq_cnt_46_ULT_rg_gap_47___d248 ;
  ...
  assign meta_out_ff_D_IN =
	     { meta_in_ff_D_OUT[1456:372],
	       10'd512,
	       meta_in_ff_D_OUT[361:0] } ;
  ...
  // remaining internal signals
  assign freq_cnt_46_ULT_rg_gap_47___d248 = freq_cnt < rg_gap ;
  assign x__h8337 = freq_cnt + 20'd1 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_send_metadata)
	$display("(%0d) enqueue iter=%d", v__h11302, rg_iter);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_start)
	begin
	  v__h14383 = $time;
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_stop) $display("(%0d) metagen stop", v__h14513);
  end
  // synopsys translate_on
