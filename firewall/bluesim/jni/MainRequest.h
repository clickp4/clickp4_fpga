...
public:
    ...
    int module_firewall_firewall_with_tcp_add_entry ( const ModuleFirewallFirewallWithTcpReqT key, const ModuleFirewallFirewallWithTcpRspT val ) { return cb->module_firewall_firewall_with_tcp_add_entry (&pint, key, val); };
    int module_firewall_firewall_with_udp_add_entry ( const ModuleFirewallFirewallWithUdpReqT key, const ModuleFirewallFirewallWithUdpRspT val ) { return cb->module_firewall_firewall_with_udp_add_entry (&pint, key, val); };
};
...
public:
    ...
    virtual void module_firewall_firewall_with_tcp_add_entry ( const ModuleFirewallFirewallWithTcpReqT key, const ModuleFirewallFirewallWithTcpRspT val ) = 0;
    virtual void module_firewall_firewall_with_udp_add_entry ( const ModuleFirewallFirewallWithUdpReqT key, const ModuleFirewallFirewallWithUdpRspT val ) = 0;
};
