...
typedef struct ModuleFirewallFirewallWithTcpReqT {
    uint8_t padding : 3;
    uint32_t src_addr : 32;
    uint32_t dst_addr : 32;
    uint16_t src_port : 16;
    uint16_t dst_port : 16;
} ModuleFirewallFirewallWithTcpReqT;
typedef struct ModuleFirewallFirewallWithTcpRspT {
    uint8_t _action : 2;
} ModuleFirewallFirewallWithTcpRspT;
typedef struct ModuleFirewallFirewallWithUdpReqT {
    uint8_t padding : 3;
    uint32_t src_addr : 32;
    uint32_t dst_addr : 32;
    uint16_t src_port : 16;
    uint16_t dst_port : 16;
} ModuleFirewallFirewallWithUdpReqT;
typedef struct ModuleFirewallFirewallWithUdpRspT {
    uint8_t _action : 2;
} ModuleFirewallFirewallWithUdpRspT;
...
} MainRequest_module_firewall_firewall_with_tcp_add_entryData;
typedef struct {
    ModuleFirewallFirewallWithUdpReqT key;
    ModuleFirewallFirewallWithUdpRspT val;
} MainRequest_module_firewall_firewall_with_udp_add_entryData;
typedef union {
    ...
    MainRequest_module_firewall_firewall_with_tcp_add_entryData module_firewall_firewall_with_tcp_add_entry;
    MainRequest_module_firewall_firewall_with_udp_add_entryData module_firewall_firewall_with_udp_add_entry;
} MainRequestData;
...
typedef struct {
    ...
    int (*module_firewall_firewall_with_tcp_add_entry) (  struct PortalInternal *p, const ModuleFirewallFirewallWithTcpReqT key, const ModuleFirewallFirewallWithTcpRspT val );
    int (*module_firewall_firewall_with_udp_add_entry) (  struct PortalInternal *p, const ModuleFirewallFirewallWithUdpReqT key, const ModuleFirewallFirewallWithUdpRspT val );
} MainRequestCb;
