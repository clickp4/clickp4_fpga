...
int MainRequestmodule_firewall_firewall_with_tcp_add_entry_cb (  struct PortalInternal *p, const ModuleFirewallFirewallWithTcpReqT key, const ModuleFirewallFirewallWithTcpRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_firewall_firewall_with_tcp_add_entry ( key, val);
    return 0;
};
int MainRequestmodule_firewall_firewall_with_udp_add_entry_cb (  struct PortalInternal *p, const ModuleFirewallFirewallWithUdpReqT key, const ModuleFirewallFirewallWithUdpRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_firewall_firewall_with_udp_add_entry ( key, val);
    return 0;
};
MainRequestCb MainRequest_cbTable = {
    ...
    MainRequestmodule_firewall_firewall_with_tcp_add_entry_cb,
    MainRequestmodule_firewall_firewall_with_udp_add_entry_cb,
};
