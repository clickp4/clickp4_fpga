...
int MainRequestJson_module_firewall_firewall_with_tcp_add_entry ( struct PortalInternal *p, const ModuleFirewallFirewallWithTcpReqT key, const ModuleFirewallFirewallWithTcpRspT val )
{
    Json::Value request;
    request.append(Json::Value("module_firewall_firewall_with_tcp_add_entry"));
    Json::Value _keyValue;
    _keyValue["__type__"]="ModuleFirewallFirewallWithTcpReqT";
    _keyValue["padding"] = (Json::UInt64)key.padding;
    _keyValue["src_addr"] = (Json::UInt64)key.src_addr;
    _keyValue["dst_addr"] = (Json::UInt64)key.dst_addr;
    _keyValue["src_port"] = (Json::UInt64)key.src_port;
    _keyValue["dst_port"] = (Json::UInt64)key.dst_port;
    request.append(_keyValue);
    Json::Value _valValue;
    _valValue["__type__"]="ModuleFirewallFirewallWithTcpRspT";
    _valValue["_action"] = (Json::UInt64)val._action;
    request.append(_valValue);

    std::string requestjson = Json::FastWriter().write(request);;
    connectalJsonSend(p, requestjson.c_str(), (int)CHAN_NUM_MainRequest_module_firewall_firewall_with_tcp_add_entry);
    return 0;
};

int MainRequestJson_module_firewall_firewall_with_udp_add_entry ( struct PortalInternal *p, const ModuleFirewallFirewallWithUdpReqT key, const ModuleFirewallFirewallWithUdpRspT val )
{
    Json::Value request;
    request.append(Json::Value("module_firewall_firewall_with_udp_add_entry"));
    Json::Value _keyValue;
    _keyValue["__type__"]="ModuleFirewallFirewallWithUdpReqT";
    _keyValue["padding"] = (Json::UInt64)key.padding;
    _keyValue["src_addr"] = (Json::UInt64)key.src_addr;
    _keyValue["dst_addr"] = (Json::UInt64)key.dst_addr;
    _keyValue["src_port"] = (Json::UInt64)key.src_port;
    ...
    request.append(_keyValue);
    Json::Value _valValue;
    _valValue["__type__"]="ModuleFirewallFirewallWithUdpRspT";
    _valValue["_action"] = (Json::UInt64)val._action;
    request.append(_valValue);

    std::string requestjson = Json::FastWriter().write(request);;
    connectalJsonSend(p, requestjson.c_str(), (int)CHAN_NUM_MainRequest_module_firewall_firewall_with_udp_add_entry);
    return 0;
};
...
MainRequestCb MainRequestJsonProxyReq = {
    ...
    MainRequestJson_module_firewall_firewall_with_tcp_add_entry,
    MainRequestJson_module_firewall_firewall_with_udp_add_entry,
};
...
int MainRequestJson_handleMessage(struct PortalInternal *p, unsigned int channel, int messageFd)
{
    ...
    case CHAN_NUM_MainRequest_module_firewall_firewall_with_tcp_add_entry: {
        ((MainRequestCb *)p->cb)->module_firewall_firewall_with_tcp_add_entry(p, tempdata.module_firewall_firewall_with_tcp_add_entry.key, tempdata.module_firewall_firewall_with_tcp_add_entry.val);
      } break;
    case CHAN_NUM_MainRequest_module_firewall_firewall_with_udp_add_entry: {
        ((MainRequestCb *)p->cb)->module_firewall_firewall_with_udp_add_entry(p, tempdata.module_firewall_firewall_with_udp_add_entry.key, tempdata.module_firewall_firewall_with_udp_add_entry.val);
      } break;
    default:
