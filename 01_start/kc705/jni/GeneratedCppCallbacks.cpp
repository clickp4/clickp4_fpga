...
int MainRequestpipeline_start_tbl_pipeline_start_add_entry_cb (  struct PortalInternal *p, const PipelineStartTblPipelineStartReqT key, const PipelineStartTblPipelineStartRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->pipeline_start_tbl_pipeline_start_add_entry ( key, val);
    return 0;
};
MainRequestCb MainRequest_cbTable = {
    ...
    MainRequestpipeline_start_tbl_pipeline_start_add_entry_cb,
};
