...
typedef struct PipelineStartTblPipelineStartReqT {
...
} MainRequest_pipeline_start_tbl_pipeline_start_add_entryData;
typedef union {
    ...
    MainRequest_pipeline_start_tbl_pipeline_start_add_entryData pipeline_start_tbl_pipeline_start_add_entry;
} MainRequestData;
...
typedef struct {
    ...
    int (*pipeline_start_tbl_pipeline_start_add_entry) (  struct PortalInternal *p, const PipelineStartTblPipelineStartReqT key, const PipelineStartTblPipelineStartRspT val );
} MainRequestCb;
