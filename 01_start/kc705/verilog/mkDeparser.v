...
//
// On Sun Jun  4 10:20:53 CST 2017
//
...
module mkDeparser(CLK,
  ...
  reg [1738 : 0] rg_metadata;
  wire [1738 : 0] rg_metadata_D_IN;
  wire rg_metadata_EN;
  ...
  wire [2006 : 0] stage2_ff_D_IN, stage2_ff_D_OUT;
  ...
  reg [63 : 0] v___1__h8030,
	       v___1__h8231,
	       v__h8263,
	       v__h8504,
	       v__h8564,
	       v__h8800;
  wire [15 : 0] mask_out__h8615, mask_out__h9031, x__h8854, x__h9108;
  wire [9 : 0] n_beat__h8177;
  ...
  // submodule stage2_ff
  FIFO2 #(.width(32'd2007), .guarded(32'd1)) stage2_ff(.RST(RST_N),
						       .CLK(CLK),
						       .D_IN(stage2_ff_D_IN),
						       .ENQ(stage2_ff_ENQ),
						       .DEQ(stage2_ff_DEQ),
  ...
  assign MUX_data_out_ff_enq_1__VAL_3 =
	     { 32'd0, rg_stage3[127:0], mask_out__h8615, rg_sop, 1'd0 } ;
  assign MUX_data_out_ff_enq_1__VAL_4 =
	     { 32'd0, rg_tmp[127:0], mask_out__h9031, 2'd0 } ;
  ...
  assign mask_out__h8615 = ~x__h8854 ;
  assign mask_out__h9031 = ~x__h9108 ;
  assign n_beat__h8177 = { 7'd0, stage3_ff_D_OUT[9:7] } ;
  assign x__h8854 = 16'd65535 << rg_processed[7:3] ;
  assign x__h9108 = 16'd65535 << rg_shift_amt[7:3] ;
  ...
  begin
	...
	rg_metadata <= `BSV_ASSIGNMENT_DELAY
	    1739';
  ...
  begin
    ...
    rg_eop = 1'h0;
    rg_metadata =
	1739';
  ...
  begin
	...
	$display("(%0d) stage2 %h len=%d",
		 v___1__h8030,
		 stage2_ff_D_OUT[2004:1749],
		 stage2_ff_D_OUT[1748:1739]);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont) $write("(%0d) stage3 cont ", v__h8504);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont)
