...
//
// On Sun Jun  4 10:19:12 CST 2017
//
...
module mkParser(CLK,
  ...
  wire [1738 : 0] meta_in_ff_D_IN, meta_in_ff_D_OUT;
  wire meta_in_ff_CLR,
       meta_in_ff_DEQ,
       meta_in_ff_EMPTY_N,
       meta_in_ff_ENQ,
  ...
  wire [511 : 0] v__h19756, v__h19830, x__h19929, x__h19932;
  wire [342 : 0] rg_condition_metadata_57_BIT_32_58_CONCAT_IF_r_ETC___d285;
  wire [47 : 0] x__h41022, x__h43447;
  wire [31 : 0] x__h25934, x__h25938, x__h39569, x__h39573;
  wire [19 : 0] ipv6_flow_label__h27227;
  wire [15 : 0] ethernet_eth_type__h41030,
		ipv6_payload_len__h27228,
		x__h21509,
		x__h22483,
		x__h25953,
		x__h25957,
		...
		x__h39543,
		x__h39565;
  wire [12 : 0] ipv4_frag_offset__h36105;
  ...
  FIFO2 #(.width(32'd1739), .guarded(32'd1)) meta_in_ff(.RST(RST_N),
							.CLK(CLK),
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept =
	     WILL_FIRE_RL_fsmrl_rl_extract_2 && v__h19756[55:48] != 8'd17 ;
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept_1 =
	     WILL_FIRE_RL_fsmrl_rl_extract_3 && v__h19756[79:72] != 8'd6 &&
	     v__h19756[79:72] != 8'd17 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept ;
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept_2 =
	     WILL_FIRE_RL_fsmrl_rl_extract_4 &&
	     ethernet_eth_type__h41030 != 16'd2048 &&
	     ethernet_eth_type__h41030 != 16'd34525 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept_1 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept ;
  ...
  assign ethernet_out_ff_x_wire_wget =
	     { 4'd9, x__h41022, x__h43447, ethernet_eth_type__h41030 } ;
  ...
  assign w_parse_ipv4_parse_udp_whas =
	     WILL_FIRE_RL_fsmrl_rl_extract_3 && v__h19756[79:72] == 8'd17 ;
  ...
  // register rg_tmp
  assign rg_tmp_D_IN =
	     WILL_FIRE_RL_rl_accept ? MUX_rg_tmp_write_1__VAL_1 : v__h19756 ;
  assign rg_tmp_EN =
  ...
  assign meta_in_ff_D_IN =
	     { ethernet_out_ff_q_0,
	       ...
	       tcp_out_ff_q_0,
	       udp_out_ff_q_0,
	       75'h2A955555554AAAAAAAA,
	       rg_click_metadata,
	       rg_condition_metadata_57_BIT_32_58_CONCAT_IF_r_ETC___d285,
  ...
  assign ethernet_eth_type__h41030 =
	     { v__h19756[103:96], v__h19756[111:104] } ;
  assign ethernet_out_ff_cntr_r_8_MINUS_1___d55 =
	     ethernet_out_ff_cntr_r - 2'd1 ;
  assign ipv4_frag_offset__h36105 = { v__h19756[52:48], v__h19756[63:56] } ;
  assign ipv4_out_ff_cntr_r_9_MINUS_1___d86 = ipv4_out_ff_cntr_r - 2'd1 ;
  assign ipv6_flow_label__h27227 =
	     { v__h19756[11:8], v__h19756[23:16], v__h19756[31:24] } ;
  assign ipv6_out_ff_cntr_r_00_MINUS_1___d117 = ipv6_out_ff_cntr_r - 2'd1 ;
  assign ipv6_payload_len__h27228 = { v__h19756[39:32], v__h19756[47:40] } ;
  assign rg_condition_metadata_57_BIT_32_58_CONCAT_IF_r_ETC___d285 =
  ...
  assign v__h19756 = data_in_tmp ? v__h19830 : rg_tmp ;
  assign v__h19830 = x__h19929 | rg_tmp ;
  assign x__h19929 = x__h19932 << rg_buffered ;
  assign x__h19932 = { 384'd0, data_in_ff_D_OUT[145:18] } ;
  assign x__h21509 = { v__h19756[55:48], v__h19756[63:56] } ;
  assign x__h22483 = { v__h19756[7:0], v__h19756[15:8] } ;
  assign x__h25934 =
	     { ipv6_payload_len__h27228,
	       v__h19756[55:48],
	       v__h19756[63:56] } ;
  assign x__h25938 =
	     { v__h19756[71:64],
	       ...
	       v__h19756[87:80],
	       v__h19756[95:88] } ;
  assign x__h25953 = { v__h19756[119:112], v__h19756[127:120] } ;
  assign x__h25957 = { v__h19756[135:128], v__h19756[143:136] } ;
  assign x__h25961 = { v__h19756[151:144], v__h19756[159:152] } ;
  assign x__h34017 = { v__h19756[3:0], v__h19756[15:12] } ;
  assign x__h39543 = { v__h19756[23:16], v__h19756[31:24] } ;
  assign x__h39565 = { v__h19756[87:80], v__h19756[95:88] } ;
  assign x__h39569 =
	     { ethernet_eth_type__h41030,
	       v__h19756[119:112],
	       v__h19756[127:120] } ;
  assign x__h39573 = { x__h25957, v__h19756[151:144], v__h19756[159:152] } ;
  assign x__h41022 =
	     { x__h22483,
	       v__h19756[23:16],
	       v__h19756[31:24],
