...
//
// On Sun Jun  4 10:19:46 CST 2017
//
...
module mkHostChannel(CLK,
  ...
  wire [1759 : 0] outReqFifo_D_IN, outReqFifo_D_OUT;
  wire outReqFifo_CLR,
       outReqFifo_DEQ,
       outReqFifo_EMPTY_N,
       outReqFifo_ENQ,
  ...
  FIFO2 #(.width(32'd1760), .guarded(32'd1)) outReqFifo(.RST(RST_N),
							.CLK(CLK),
