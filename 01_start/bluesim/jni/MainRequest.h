...
public:
    ...
    int pipeline_start_tbl_pipeline_start_add_entry ( const PipelineStartTblPipelineStartReqT key, const PipelineStartTblPipelineStartRspT val ) { return cb->pipeline_start_tbl_pipeline_start_add_entry (&pint, key, val); };
};
...
public:
    ...
    virtual void pipeline_start_tbl_pipeline_start_add_entry ( const PipelineStartTblPipelineStartReqT key, const PipelineStartTblPipelineStartRspT val ) = 0;
};
