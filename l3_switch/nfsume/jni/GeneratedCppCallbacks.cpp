...
int MainRequestmodule_l3_switch_forward_table_add_entry_cb (  struct PortalInternal *p, const ModuleL3SwitchForwardTableReqT key, const ModuleL3SwitchForwardTableRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_l3_switch_forward_table_add_entry ( key, val);
    return 0;
};
int MainRequestmodule_l3_switch_ipv4_nhop_add_entry_cb (  struct PortalInternal *p, const ModuleL3SwitchIpv4NhopReqT key, const ModuleL3SwitchIpv4NhopRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_l3_switch_ipv4_nhop_add_entry ( key, val);
    return 0;
};
int MainRequestmodule_l3_switch_send_frame_add_entry_cb (  struct PortalInternal *p, const ModuleL3SwitchSendFrameReqT key, const ModuleL3SwitchSendFrameRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_l3_switch_send_frame_add_entry ( key, val);
    return 0;
};
MainRequestCb MainRequest_cbTable = {
    ...
    MainRequestmodule_l3_switch_forward_table_add_entry_cb,
    MainRequestmodule_l3_switch_ipv4_nhop_add_entry_cb,
    MainRequestmodule_l3_switch_send_frame_add_entry_cb,
};
