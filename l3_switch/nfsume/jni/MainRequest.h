...
public:
    ...
    int module_l3_switch_forward_table_add_entry ( const ModuleL3SwitchForwardTableReqT key, const ModuleL3SwitchForwardTableRspT val ) { return cb->module_l3_switch_forward_table_add_entry (&pint, key, val); };
    int module_l3_switch_ipv4_nhop_add_entry ( const ModuleL3SwitchIpv4NhopReqT key, const ModuleL3SwitchIpv4NhopRspT val ) { return cb->module_l3_switch_ipv4_nhop_add_entry (&pint, key, val); };
    int module_l3_switch_send_frame_add_entry ( const ModuleL3SwitchSendFrameReqT key, const ModuleL3SwitchSendFrameRspT val ) { return cb->module_l3_switch_send_frame_add_entry (&pint, key, val); };
};
...
public:
    ...
    virtual void module_l3_switch_forward_table_add_entry ( const ModuleL3SwitchForwardTableReqT key, const ModuleL3SwitchForwardTableRspT val ) = 0;
    virtual void module_l3_switch_ipv4_nhop_add_entry ( const ModuleL3SwitchIpv4NhopReqT key, const ModuleL3SwitchIpv4NhopRspT val ) = 0;
    virtual void module_l3_switch_send_frame_add_entry ( const ModuleL3SwitchSendFrameReqT key, const ModuleL3SwitchSendFrameRspT val ) = 0;
};
