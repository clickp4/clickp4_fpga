...
typedef struct ModuleL3SwitchForwardTableReqT {
    uint8_t padding : 4;
    uint32_t nhop_ipv4 : 32;
} ModuleL3SwitchForwardTableReqT;
typedef struct ModuleL3SwitchForwardTableRspT {
    uint8_t _action : 1;
    uint64_t _dmac : 48;
    uint16_t _port : 9;
} ModuleL3SwitchForwardTableRspT;
typedef struct ModuleL3SwitchIpv4NhopReqT {
    uint8_t padding : 4;
    uint32_t dst_addr : 32;
} ModuleL3SwitchIpv4NhopReqT;
typedef struct ModuleL3SwitchIpv4NhopRspT {
    uint8_t _action : 1;
    uint32_t _nhop_ipv4 : 32;
} ModuleL3SwitchIpv4NhopRspT;
typedef struct ModuleL3SwitchSendFrameReqT {
    uint16_t egress_spec : 9;
} ModuleL3SwitchSendFrameReqT;
typedef struct ModuleL3SwitchSendFrameRspT {
    uint8_t _action : 1;
    uint64_t _smac : 48;
} ModuleL3SwitchSendFrameRspT;
...
} MainRequest_module_l3_switch_forward_table_add_entryData;
typedef struct {
    ModuleL3SwitchIpv4NhopReqT key;
    ModuleL3SwitchIpv4NhopRspT val;
} MainRequest_module_l3_switch_ipv4_nhop_add_entryData;
typedef struct {
    ModuleL3SwitchSendFrameReqT key;
    ModuleL3SwitchSendFrameRspT val;
} MainRequest_module_l3_switch_send_frame_add_entryData;
typedef union {
    ...
    MainRequest_module_l3_switch_forward_table_add_entryData module_l3_switch_forward_table_add_entry;
    MainRequest_module_l3_switch_ipv4_nhop_add_entryData module_l3_switch_ipv4_nhop_add_entry;
    MainRequest_module_l3_switch_send_frame_add_entryData module_l3_switch_send_frame_add_entry;
} MainRequestData;
...
typedef struct {
    ...
    int (*module_l3_switch_forward_table_add_entry) (  struct PortalInternal *p, const ModuleL3SwitchForwardTableReqT key, const ModuleL3SwitchForwardTableRspT val );
    int (*module_l3_switch_ipv4_nhop_add_entry) (  struct PortalInternal *p, const ModuleL3SwitchIpv4NhopReqT key, const ModuleL3SwitchIpv4NhopRspT val );
    int (*module_l3_switch_send_frame_add_entry) (  struct PortalInternal *p, const ModuleL3SwitchSendFrameReqT key, const ModuleL3SwitchSendFrameRspT val );
} MainRequestCb;
