...
//
// On Sun Jun  4 09:44:59 CST 2017
//
...
module mkHostChannel(CLK,
  ...
  wire [1793 : 0] outReqFifo_D_IN, outReqFifo_D_OUT;
  wire outReqFifo_CLR,
       outReqFifo_DEQ,
       outReqFifo_EMPTY_N,
       outReqFifo_ENQ,
  ...
  FIFO2 #(.width(32'd1794), .guarded(32'd1)) outReqFifo(.RST(RST_N),
							.CLK(CLK),
