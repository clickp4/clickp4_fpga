...
//
// On Sun Jun  4 09:47:53 CST 2017
//
...
module mkMetaGenChannel(CLK,
  ...
  wire [1793 : 0] host_outReqFifo_D_IN, host_outReqFifo_D_OUT;
  ...
  wire [1772 : 0] host_parser_meta_get;
  ...
  wire [1793 : 0] meta_in_ff_D_IN, meta_in_ff_D_OUT;
  wire meta_in_ff_CLR,
       meta_in_ff_DEQ,
       meta_in_ff_EMPTY_N,
       meta_in_ff_ENQ,
  ...
  wire [1793 : 0] meta_out_ff_D_IN, meta_out_ff_D_OUT;
  ...
  reg [63 : 0] v__h13136, v__h16833, v__h16963;
  wire [19 : 0] x__h9562;
  wire freq_cnt_10_ULT_rg_gap_11___d312;
  ...
  FIFO2 #(.width(32'd1794), .guarded(32'd1)) host_outReqFifo(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd1794), .guarded(32'd1)) meta_in_ff(.RST(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd1794), .guarded(32'd1)) meta_out_ff(.RST(RST_N),
							 .CLK(CLK),
  ...
  assign MUX_freq_cnt_write_1__VAL_2 =
	     freq_cnt_10_ULT_rg_gap_11___d312 ? x__h9562 : 20'd0 ;
  assign MUX_rg_iter_write_1__VAL_3 = rg_iter - 20'd1 ;

  // inlined wires
  assign w_send_meta_whas =
	     WILL_FIRE_RL_rl_freq_ctrl && !freq_cnt_10_ULT_rg_gap_11___d312 ;
  ...
  // remaining internal signals
  assign freq_cnt_10_ULT_rg_gap_11___d312 = freq_cnt < rg_gap ;
  assign x__h9562 = freq_cnt + 20'd1 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_send_metadata)
	$display("(%0d) enqueue iter=%d", v__h13136, rg_iter);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_start)
	begin
	  v__h16833 = $time;
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_stop) $display("(%0d) metagen stop", v__h16963);
  end
  // synopsys translate_on
