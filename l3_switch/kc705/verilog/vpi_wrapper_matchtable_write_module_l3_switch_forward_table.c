 ...
 *     #include "vpi_wrapper_matchtable_write_module_l3_switch_forward_table.h"
 *     void (*vlog_startup_routines[])() = { matchtable_write_module_l3_switch_forward_table_vpi_register,
 *     				      0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
...
void matchtable_write_module_l3_switch_forward_table(unsigned long long , char );

/* VPI wrapper function */
PLI_INT32 matchtable_write_module_l3_switch_forward_table_calltf(PLI_BYTE8 *user_data)
{
  vpiHandle hCall;
  ...
  matchtable_write_module_l3_switch_forward_table(arg_1, arg_2);
...
void matchtable_write_module_l3_switch_forward_table_vpi_register()
{
  s_vpi_systf_data tf_data;
  
  /* Fill in registration data */
  tf_data.type = vpiSysTask;
  tf_data.tfname = "$imported_matchtable_write_module_l3_switch_forward_table";
  tf_data.calltf = matchtable_write_module_l3_switch_forward_table_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_matchtable_write_module_l3_switch_forward_table";
