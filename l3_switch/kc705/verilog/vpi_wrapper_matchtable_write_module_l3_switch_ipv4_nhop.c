 ...
 *     #include "vpi_wrapper_matchtable_write_module_l3_switch_ipv4_nhop.h"
 *     void (*vlog_startup_routines[])() = { matchtable_write_module_l3_switch_ipv4_nhop_vpi_register,
 *     				      0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
...
void matchtable_write_module_l3_switch_ipv4_nhop(unsigned long long , char );
...
PLI_INT32 matchtable_write_module_l3_switch_ipv4_nhop_calltf(PLI_BYTE8 *user_data)
{
  ...
  matchtable_write_module_l3_switch_ipv4_nhop(arg_1, arg_2);
...
void matchtable_write_module_l3_switch_ipv4_nhop_vpi_register()
{
  ...
  tf_data.tfname = "$imported_matchtable_write_module_l3_switch_ipv4_nhop";
  tf_data.calltf = matchtable_write_module_l3_switch_ipv4_nhop_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_matchtable_write_module_l3_switch_ipv4_nhop";
