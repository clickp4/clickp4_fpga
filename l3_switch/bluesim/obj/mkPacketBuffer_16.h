...
/* Generation options: */
#ifndef __mkPacketBuffer_16_h__
#define __mkPacketBuffer_16_h__
...
/* Class declaration for the mkPacketBuffer_16 module */
class MOD_mkPacketBuffer_16 : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkPacketBuffer_16(tSimStateHdl simHdl,
			char const *name,
			Module *parent,
 ...
 public:
  tUInt8 DEF_memBuffer_serverAdapterB_outData_outData_wget__ETC___d251;
  tUInt8 DEF_fifoWriteData_first__33_BIT_0___d134;
  tUWide DEF_memBuffer_serverAdapterB_outData_outData_wget____d250;
 ...
 /* Local definitions */
 private:
  tUInt64 DEF_v__h7541;
  tUInt64 DEF_v__h6889;
  tUInt64 DEF_v__h6558;
  tUInt64 DEF_v__h6376;
  tUInt64 DEF_v__h6104;
  tUInt64 DEF_v__h5224;
  tUWide DEF_incomingReqs_first____d212;
  ...
  tUInt64 DEF_x__h7845;
  tUInt64 DEF_x__h7840;
  tUInt32 DEF_b__h5213;
  tUInt8 DEF_x__h7490;
  tUWide DEF_incomingReqs_first__12_BITS_177_TO_0___d218;
  tUWide DEF_incomingReqs_first__12_BITS_145_TO_18___d214;
  tUWide DEF_fifoWriteData_first__33_BITS_145_TO_18___d147;
  tUInt32 DEF_incomingReqs_first__12_BITS_177_TO_146___d215;
  tUInt8 DEF_incomingReqs_first__12_BITS_185_TO_178___d213;
  tUInt8 DEF_incomingReqs_first__12_BIT_1___d216;
  tUInt8 DEF_incomingReqs_first__12_BIT_0___d217;
  tUWide DEF_wrCurrPtr_40_CONCAT_fifoWriteData_first__33___d141;
  tUWide DEF_sopDeq_45_CONCAT_eopDeq_57___d265;
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkPacketBuffer_16 &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkPacketBuffer_16 &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkPacketBuffer_16 &backing);
};

#endif /* ifndef __mkPacketBuffer_16_h__ */
