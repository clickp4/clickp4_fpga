...
/* Generation options: */
#ifndef __mkMatchTable_ModuleForForInit_h__
#define __mkMatchTable_ModuleForForInit_h__
...
/* Class declaration for the mkMatchTable_ModuleForForInit module */
class MOD_mkMatchTable_ModuleForForInit : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkMatchTable_ModuleForForInit(tSimStateHdl simHdl,
				    char const *name,
				    Module *parent,
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkMatchTable_ModuleForForInit &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkMatchTable_ModuleForForInit &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkMatchTable_ModuleForForInit &backing);
};

#endif /* ifndef __mkMatchTable_ModuleForForInit_h__ */
