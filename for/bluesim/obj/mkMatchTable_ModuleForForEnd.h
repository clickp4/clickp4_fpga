...
/* Generation options: */
#ifndef __mkMatchTable_ModuleForForEnd_h__
#define __mkMatchTable_ModuleForForEnd_h__
...
/* Class declaration for the mkMatchTable_ModuleForForEnd module */
class MOD_mkMatchTable_ModuleForForEnd : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkMatchTable_ModuleForForEnd(tSimStateHdl simHdl,
				   char const *name,
				   Module *parent,
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkMatchTable_ModuleForForEnd &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkMatchTable_ModuleForForEnd &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkMatchTable_ModuleForForEnd &backing);
};

#endif /* ifndef __mkMatchTable_ModuleForForEnd_h__ */
