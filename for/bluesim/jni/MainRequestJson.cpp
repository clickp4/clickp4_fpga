...
int MainRequestJson_module_for_for_end_add_entry ( struct PortalInternal *p, const ModuleForForEndReqT key, const ModuleForForEndRspT val )
{
    Json::Value request;
    request.append(Json::Value("module_for_for_end_add_entry"));
    Json::Value _keyValue;
    _keyValue["__type__"]="ModuleForForEndReqT";
    ...
    _valValue["__type__"]="ModuleForForEndRspT";
    ...
    std::string requestjson = Json::FastWriter().write(request);;
    connectalJsonSend(p, requestjson.c_str(), (int)CHAN_NUM_MainRequest_module_for_for_end_add_entry);
    return 0;
};

int MainRequestJson_module_for_for_init_add_entry ( struct PortalInternal *p, const ModuleForForInitReqT key, const ModuleForForInitRspT val )
{
    Json::Value request;
    request.append(Json::Value("module_for_for_init_add_entry"));
    Json::Value _keyValue;
    _keyValue["__type__"]="ModuleForForInitReqT";
    _keyValue["padding"] = (Json::UInt64)key.padding;
    _keyValue["click_id"] = (Json::UInt64)key.click_id;
    request.append(_keyValue);
    Json::Value _valValue;
    _valValue["__type__"]="ModuleForForInitRspT";
    _valValue["_action"] = (Json::UInt64)val._action;
    _valValue["_threshold"] = (Json::UInt64)val._threshold;
    request.append(_valValue);

    std::string requestjson = Json::FastWriter().write(request);;
    connectalJsonSend(p, requestjson.c_str(), (int)CHAN_NUM_MainRequest_module_for_for_init_add_entry);
    return 0;
};

int MainRequestJson_module_for_for_loop_add_entry ( struct PortalInternal *p, const ModuleForForLoopReqT key, const ModuleForForLoopRspT val )
{
    Json::Value request;
    request.append(Json::Value("module_for_for_loop_add_entry"));
    Json::Value _keyValue;
    _keyValue["__type__"]="ModuleForForLoopReqT";
    _keyValue["padding"] = (Json::UInt64)key.padding;
    _keyValue["click_id"] = (Json::UInt64)key.click_id;
    request.append(_keyValue);
    Json::Value _valValue;
    _valValue["__type__"]="ModuleForForLoopRspT";
    _valValue["_action"] = (Json::UInt64)val._action;
    _valValue["_bitmap"] = (Json::UInt64)val._bitmap;
    request.append(_valValue);

    std::string requestjson = Json::FastWriter().write(request);;
    connectalJsonSend(p, requestjson.c_str(), (int)CHAN_NUM_MainRequest_module_for_for_loop_add_entry);
    return 0;
};
...
MainRequestCb MainRequestJsonProxyReq = {
    ...
    MainRequestJson_module_for_for_end_add_entry,
    MainRequestJson_module_for_for_init_add_entry,
    MainRequestJson_module_for_for_loop_add_entry,
};
...
int MainRequestJson_handleMessage(struct PortalInternal *p, unsigned int channel, int messageFd)
{
    ...
    case CHAN_NUM_MainRequest_module_for_for_end_add_entry: {
        ((MainRequestCb *)p->cb)->module_for_for_end_add_entry(p, tempdata.module_for_for_end_add_entry.key, tempdata.module_for_for_end_add_entry.val);
      } break;
    case CHAN_NUM_MainRequest_module_for_for_init_add_entry: {
        ((MainRequestCb *)p->cb)->module_for_for_init_add_entry(p, tempdata.module_for_for_init_add_entry.key, tempdata.module_for_for_init_add_entry.val);
      } break;
    case CHAN_NUM_MainRequest_module_for_for_loop_add_entry: {
        ((MainRequestCb *)p->cb)->module_for_for_loop_add_entry(p, tempdata.module_for_for_loop_add_entry.key, tempdata.module_for_for_loop_add_entry.val);
      } break;
    default:
