...
public:
    ...
    int module_for_for_end_add_entry ( const ModuleForForEndReqT key, const ModuleForForEndRspT val ) { return cb->module_for_for_end_add_entry (&pint, key, val); };
    int module_for_for_init_add_entry ( const ModuleForForInitReqT key, const ModuleForForInitRspT val ) { return cb->module_for_for_init_add_entry (&pint, key, val); };
    int module_for_for_loop_add_entry ( const ModuleForForLoopReqT key, const ModuleForForLoopRspT val ) { return cb->module_for_for_loop_add_entry (&pint, key, val); };
};
...
public:
    ...
    virtual void module_for_for_end_add_entry ( const ModuleForForEndReqT key, const ModuleForForEndRspT val ) = 0;
    virtual void module_for_for_init_add_entry ( const ModuleForForInitReqT key, const ModuleForForInitRspT val ) = 0;
    virtual void module_for_for_loop_add_entry ( const ModuleForForLoopReqT key, const ModuleForForLoopRspT val ) = 0;
};
