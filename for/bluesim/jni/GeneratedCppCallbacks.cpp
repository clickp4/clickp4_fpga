...
int MainRequestmodule_for_for_end_add_entry_cb (  struct PortalInternal *p, const ModuleForForEndReqT key, const ModuleForForEndRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_for_for_end_add_entry ( key, val);
    return 0;
};
int MainRequestmodule_for_for_init_add_entry_cb (  struct PortalInternal *p, const ModuleForForInitReqT key, const ModuleForForInitRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_for_for_init_add_entry ( key, val);
    return 0;
};
int MainRequestmodule_for_for_loop_add_entry_cb (  struct PortalInternal *p, const ModuleForForLoopReqT key, const ModuleForForLoopRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_for_for_loop_add_entry ( key, val);
    return 0;
};
MainRequestCb MainRequest_cbTable = {
    ...
    MainRequestmodule_for_for_end_add_entry_cb,
    MainRequestmodule_for_for_init_add_entry_cb,
    MainRequestmodule_for_for_loop_add_entry_cb,
};
