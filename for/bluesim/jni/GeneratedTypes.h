...
typedef struct ModuleForForEndReqT {
    uint8_t padding : 4;
    uint32_t click_id : 32;
} ModuleForForEndReqT;
typedef struct ModuleForForEndRspT {
    uint8_t _action : 1;
    uint8_t _state : 8;
    uint64_t _bitmap : 64;
} ModuleForForEndRspT;
typedef struct ModuleForForInitReqT {
    uint8_t padding : 4;
    uint32_t click_id : 32;
} ModuleForForInitReqT;
typedef struct ModuleForForInitRspT {
    uint8_t _action : 1;
    uint32_t _threshold : 32;
} ModuleForForInitRspT;
typedef struct ModuleForForLoopReqT {
    uint8_t padding : 4;
    uint32_t click_id : 32;
} ModuleForForLoopReqT;
typedef struct ModuleForForLoopRspT {
    uint8_t _action : 1;
    uint64_t _bitmap : 64;
} ModuleForForLoopRspT;
...
} MainRequest_module_for_for_end_add_entryData;
typedef struct {
    ModuleForForInitReqT key;
    ModuleForForInitRspT val;
} MainRequest_module_for_for_init_add_entryData;
typedef struct {
    ModuleForForLoopReqT key;
    ModuleForForLoopRspT val;
} MainRequest_module_for_for_loop_add_entryData;
typedef union {
    ...
    MainRequest_module_for_for_end_add_entryData module_for_for_end_add_entry;
    MainRequest_module_for_for_init_add_entryData module_for_for_init_add_entry;
    MainRequest_module_for_for_loop_add_entryData module_for_for_loop_add_entry;
} MainRequestData;
...
typedef struct {
    ...
    int (*module_for_for_end_add_entry) (  struct PortalInternal *p, const ModuleForForEndReqT key, const ModuleForForEndRspT val );
    int (*module_for_for_init_add_entry) (  struct PortalInternal *p, const ModuleForForInitReqT key, const ModuleForForInitRspT val );
    int (*module_for_for_loop_add_entry) (  struct PortalInternal *p, const ModuleForForLoopReqT key, const ModuleForForLoopRspT val );
} MainRequestCb;
