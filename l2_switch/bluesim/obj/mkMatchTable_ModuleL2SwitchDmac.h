...
/* Generation options: */
#ifndef __mkMatchTable_ModuleL2SwitchDmac_h__
#define __mkMatchTable_ModuleL2SwitchDmac_h__
...
/* Class declaration for the mkMatchTable_ModuleL2SwitchDmac module */
class MOD_mkMatchTable_ModuleL2SwitchDmac : public Module {
 ...
 public:
  ...
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_evictee_gslots_0;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_evictee_gslots_1;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_evictee_gslots_2;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_evictee_gslots_3;
  ...
  MOD_BRAM<tUInt32,tUInt32,tUInt8> INST_ret_ifc_dmhc_hash_units_0_g_table;
  ...
  MOD_BRAM<tUInt32,tUInt32,tUInt8> INST_ret_ifc_dmhc_hash_units_1_g_table;
  ...
  MOD_BRAM<tUInt32,tUInt32,tUInt8> INST_ret_ifc_dmhc_hash_units_2_g_table;
  ...
  MOD_BRAM<tUInt32,tUInt32,tUInt8> INST_ret_ifc_dmhc_hash_units_3_g_table;
  ...
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_new_gslots_0;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_new_gslots_1;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_new_gslots_2;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_new_gslots_3;
  ...
  MOD_Wire<tUInt32> INST_ret_ifc_dmhc_rec_value;
  MOD_Reg<tUInt8> INST_ret_ifc_dmhc_repair_g_index;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_repair_gslot;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_repair_gslots_0;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_repair_gslots_1;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_repair_gslots_2;
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_repair_gslots_3;
  ...
  MOD_Reg<tUInt32> INST_ret_ifc_dmhc_victim_gslot;
  MOD_Reg<tUWide> INST_ret_ifc_dmhc_victim_mslot;
  MOD_Reg<tUInt8> INST_ret_ifc_dmhc_victim_mslot_addr;
  MOD_Fifo<tUInt32> INST_ret_ifc_readDataFifo;
  MOD_Fifo<tUInt64> INST_ret_ifc_readReqFifo;
 
 /* Constructor */
 public:
  MOD_mkMatchTable_ModuleL2SwitchDmac(tSimStateHdl simHdl,
				      char const *name,
				      Module *parent,
 ...
 private:
  ...
  tUInt32 DEF_ret_ifc_dmhc_new_gslots_3___d850;
  tUInt32 DEF_ret_ifc_dmhc_new_gslots_2___d852;
  tUInt32 DEF_ret_ifc_dmhc_new_gslots_1___d854;
  tUInt32 DEF_ret_ifc_dmhc_new_gslots_0___d856;
  tUInt32 DEF_ret_ifc_dmhc_repair_gslots_3___d270;
  tUInt32 DEF_ret_ifc_dmhc_repair_gslots_2___d272;
  tUInt32 DEF_ret_ifc_dmhc_repair_gslots_1___d274;
  tUInt32 DEF_ret_ifc_dmhc_repair_gslots_0___d276;
  tUInt32 DEF_ret_ifc_dmhc_evictee_gslots_3___d630;
  tUInt32 DEF_ret_ifc_dmhc_evictee_gslots_2___d621;
  tUInt32 DEF_ret_ifc_dmhc_evictee_gslots_1___d612;
  tUInt32 DEF_ret_ifc_dmhc_evictee_gslots_0___d603;
  tUInt32 DEF_ret_ifc_dmhc_hash_units_3_g_table_a_read____d267;
  tUInt32 DEF_ret_ifc_dmhc_hash_units_2_g_table_a_read____d266;
  tUInt32 DEF_ret_ifc_dmhc_hash_units_1_g_table_a_read____d265;
  tUInt32 DEF_ret_ifc_dmhc_hash_units_0_g_table_a_read____d264;
 ...
 public:
  ...
  tUInt32 METH_lookupPort_response_get();
  ...
  void METH_modify_entry_put(tUInt32 ARG_modify_entry_put);
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkMatchTable_ModuleL2SwitchDmac &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkMatchTable_ModuleL2SwitchDmac &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkMatchTable_ModuleL2SwitchDmac &backing);
};

#endif /* ifndef __mkMatchTable_ModuleL2SwitchDmac_h__ */
