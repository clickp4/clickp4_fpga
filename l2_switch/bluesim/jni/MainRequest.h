...
public:
    ...
    int module_l2_switch_dmac_add_entry ( const ModuleL2SwitchDmacReqT key, const ModuleL2SwitchDmacRspT val ) { return cb->module_l2_switch_dmac_add_entry (&pint, key, val); };
    int module_l2_switch_smac_add_entry ( const ModuleL2SwitchSmacReqT key, const ModuleL2SwitchSmacRspT val ) { return cb->module_l2_switch_smac_add_entry (&pint, key, val); };
};
...
public:
    ...
    virtual void module_l2_switch_dmac_add_entry ( const ModuleL2SwitchDmacReqT key, const ModuleL2SwitchDmacRspT val ) = 0;
    virtual void module_l2_switch_smac_add_entry ( const ModuleL2SwitchSmacReqT key, const ModuleL2SwitchSmacRspT val ) = 0;
};
