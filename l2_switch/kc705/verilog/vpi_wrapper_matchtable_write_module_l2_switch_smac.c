 ...
 *     #include "vpi_wrapper_matchtable_write_module_l2_switch_smac.h"
 *     void (*vlog_startup_routines[])() = { matchtable_write_module_l2_switch_smac_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void matchtable_write_module_l2_switch_smac(unsigned long long , char );
...
PLI_INT32 matchtable_write_module_l2_switch_smac_calltf(PLI_BYTE8 *user_data)
{
  ...
  matchtable_write_module_l2_switch_smac(arg_1, arg_2);
...
void matchtable_write_module_l2_switch_smac_vpi_register()
{
  ...
  tf_data.tfname = "$imported_matchtable_write_module_l2_switch_smac";
  tf_data.calltf = matchtable_write_module_l2_switch_smac_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_matchtable_write_module_l2_switch_smac";
