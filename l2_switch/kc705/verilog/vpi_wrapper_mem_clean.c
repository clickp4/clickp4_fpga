 ...
 * 
 * On Sun Jun  4 09:24:09 CST 2017
 * 
 * To automatically register this VPI wrapper with a Verilog simulator use:
 *     #include "vpi_wrapper_mem_clean.h"
 *     void (*vlog_startup_routines[])() = { mem_clean_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void mem_clean(unsigned long long );

/* VPI wrapper function */
PLI_INT32 mem_clean_calltf(PLI_BYTE8 *user_data)
{
  vpiHandle hCall;
...
void mem_clean_vpi_register()
{
  s_vpi_systf_data tf_data;
  
  /* Fill in registration data */
  tf_data.type = vpiSysTask;
  tf_data.tfname = "$imported_mem_clean";
  tf_data.calltf = mem_clean_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_mem_clean";
