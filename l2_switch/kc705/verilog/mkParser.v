...
//
// On Sun Jun  4 09:43:12 CST 2017
//
...
module mkParser(CLK,
  ...
  wire [1761 : 0] meta_in_ff_D_IN, meta_in_ff_D_OUT;
  wire meta_in_ff_CLR,
       meta_in_ff_DEQ,
       meta_in_ff_EMPTY_N,
       meta_in_ff_ENQ,
  ...
  wire [511 : 0] v__h19713, v__h19787, x__h19886, x__h19889;
  wire [309 : 0] rg_for_metadata_61_BIT_64_62_CONCAT_IF_rg_for__ETC___d285;
  wire [47 : 0] x__h40979, x__h43404;
  wire [31 : 0] x__h25891, x__h25895, x__h39526, x__h39530;
  wire [19 : 0] ipv6_flow_label__h27184;
  wire [15 : 0] ethernet_eth_type__h40987,
		ipv6_payload_len__h27185,
		x__h21466,
		x__h22440,
		x__h25910,
		x__h25914,
		...
		x__h39500,
		x__h39522;
  wire [12 : 0] ipv4_frag_offset__h36062;
  wire [9 : 0] x_port1__read__h15079, x_port1__read__h15095;
  wire [7 : 0] x__h33974;
  ...
  FIFO2 #(.width(32'd1762), .guarded(32'd1)) meta_in_ff(.RST(RST_N),
							.CLK(CLK),
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept =
	     WILL_FIRE_RL_fsmrl_rl_extract_2 && v__h19713[55:48] != 8'd17 ;
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept_1 =
	     WILL_FIRE_RL_fsmrl_rl_extract_3 && v__h19713[79:72] != 8'd6 &&
	     v__h19713[79:72] != 8'd17 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept ;
  ...
  assign WILL_FIRE_RL_fsmrl_rl_accept_2 =
	     WILL_FIRE_RL_fsmrl_rl_extract_4 &&
	     ethernet_eth_type__h40987 != 16'd2048 &&
	     ethernet_eth_type__h40987 != 16'd34525 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept_1 &&
	     !WILL_FIRE_RL_fsmrl_rl_accept ;
  ...
  assign ethernet_out_ff_x_wire_wget =
	     { 4'd9, x__h40979, x__h43404, ethernet_eth_type__h40987 } ;
  ...
  assign w_parse_ipv4_parse_udp_whas =
	     WILL_FIRE_RL_fsmrl_rl_extract_3 && v__h19713[79:72] == 8'd17 ;
  ...
  assign rg_buffered_port2__read =
	     WILL_FIRE_RL_rl_start_state_deq ? 10'd0 : x_port1__read__h15079 ;
  ...
  assign data_in_tmp_EN_port1__write =
	     WILL_FIRE_RL_rl_start_state_deq ||
	     !parse_done_port1__read &&
	     x_port1__read__h15079 < x_port1__read__h15095 &&
	     w_parse_header_done_whas ;
  ...
  // register rg_next_header_len
  assign rg_next_header_len_D_IN = x_port1__read__h15095 ;
  ...
  // register rg_tmp
  assign rg_tmp_D_IN =
	     WILL_FIRE_RL_rl_accept ? MUX_rg_tmp_write_1__VAL_1 : v__h19713 ;
  assign rg_tmp_EN =
  ...
  assign meta_in_ff_D_IN =
	     { ethernet_out_ff_q_0,
	       ...
	       tcp_out_ff_q_0,
	       udp_out_ff_q_0,
	       98'h1555555555554AAAAAAAAAAAA,
	       rg_click_metadata,
	       rg_condition_metadata,
	       rg_for_metadata_61_BIT_64_62_CONCAT_IF_rg_for__ETC___d285,
  ...
  assign ethernet_eth_type__h40987 =
	     { v__h19713[103:96], v__h19713[111:104] } ;
  assign ethernet_out_ff_cntr_r_8_MINUS_1___d55 =
	     ethernet_out_ff_cntr_r - 2'd1 ;
  assign ipv4_frag_offset__h36062 = { v__h19713[52:48], v__h19713[63:56] } ;
  assign ipv4_out_ff_cntr_r_9_MINUS_1___d86 = ipv4_out_ff_cntr_r - 2'd1 ;
  assign ipv6_flow_label__h27184 =
	     { v__h19713[11:8], v__h19713[23:16], v__h19713[31:24] } ;
  assign ipv6_out_ff_cntr_r_00_MINUS_1___d117 = ipv6_out_ff_cntr_r - 2'd1 ;
  assign ipv6_payload_len__h27185 = { v__h19713[39:32], v__h19713[47:40] } ;
  assign rg_for_metadata_61_BIT_64_62_CONCAT_IF_rg_for__ETC___d285 =
	     { rg_for_metadata,
	       rg_if_metadata,
  ...
  assign v__h19713 = data_in_tmp ? v__h19787 : rg_tmp ;
  assign v__h19787 = x__h19886 | rg_tmp ;
  assign x__h19886 = x__h19889 << rg_buffered ;
  assign x__h19889 = { 384'd0, data_in_ff_D_OUT[145:18] } ;
  assign x__h21466 = { v__h19713[55:48], v__h19713[63:56] } ;
  assign x__h22440 = { v__h19713[7:0], v__h19713[15:8] } ;
  assign x__h25891 =
	     { ipv6_payload_len__h27185,
	       v__h19713[55:48],
	       v__h19713[63:56] } ;
  assign x__h25895 =
	     { v__h19713[71:64],
	       ...
	       v__h19713[87:80],
	       v__h19713[95:88] } ;
  assign x__h25910 = { v__h19713[119:112], v__h19713[127:120] } ;
  assign x__h25914 = { v__h19713[135:128], v__h19713[143:136] } ;
  assign x__h25918 = { v__h19713[151:144], v__h19713[159:152] } ;
  assign x__h33974 = { v__h19713[3:0], v__h19713[15:12] } ;
  assign x__h39500 = { v__h19713[23:16], v__h19713[31:24] } ;
  assign x__h39522 = { v__h19713[87:80], v__h19713[95:88] } ;
  assign x__h39526 =
	     { ethernet_eth_type__h40987,
	       v__h19713[119:112],
	       v__h19713[127:120] } ;
  assign x__h39530 = { x__h25914, v__h19713[151:144], v__h19713[159:152] } ;
  assign x__h40979 =
	     { x__h22440,
	       v__h19713[23:16],
	       v__h19713[31:24],
  ...
  assign x__h43404 =
	     { x__h21466,
	       ...
	       v__h19713[87:80],
	       v__h19713[95:88] } ;
  assign x_port1__read__h15079 =
	     rg_buffered_EN_port0__write ?
	       rg_buffered_port0__write_1 :
	       rg_buffered ;
  assign x_port1__read__h15095 =
