...
//
// On Sun Jun  4 09:43:47 CST 2017
//
...
module mkHostChannel(CLK,
  ...
  wire [1782 : 0] outReqFifo_D_IN, outReqFifo_D_OUT;
  wire outReqFifo_CLR,
       outReqFifo_DEQ,
       outReqFifo_EMPTY_N,
       outReqFifo_ENQ,
  ...
  FIFO2 #(.width(32'd1783), .guarded(32'd1)) outReqFifo(.RST(RST_N),
							.CLK(CLK),
