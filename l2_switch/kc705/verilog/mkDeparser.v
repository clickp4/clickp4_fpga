...
//
// On Sun Jun  4 09:44:54 CST 2017
//
...
module mkDeparser(CLK,
  ...
  reg [1761 : 0] rg_metadata;
  wire [1761 : 0] rg_metadata_D_IN;
  wire rg_metadata_EN;
  ...
  wire [2029 : 0] stage2_ff_D_IN, stage2_ff_D_OUT;
  ...
  reg [63 : 0] v___1__h7921,
	       v___1__h8122,
	       v__h8154,
	       v__h8395,
	       v__h8455,
	       v__h8691;
  wire [15 : 0] mask_out__h8506, mask_out__h8922, x__h8745, x__h8999;
  wire [9 : 0] n_beat__h8068;
  ...
  // submodule stage2_ff
  FIFO2 #(.width(32'd2030), .guarded(32'd1)) stage2_ff(.RST(RST_N),
						       .CLK(CLK),
						       .D_IN(stage2_ff_D_IN),
						       .ENQ(stage2_ff_ENQ),
						       .DEQ(stage2_ff_DEQ),
  ...
  assign MUX_data_out_ff_enq_1__VAL_3 =
	     { 32'd0, rg_stage3[127:0], mask_out__h8506, rg_sop, 1'd0 } ;
  assign MUX_data_out_ff_enq_1__VAL_4 =
	     { 32'd0, rg_tmp[127:0], mask_out__h8922, 2'd0 } ;
  ...
  assign mask_out__h8506 = ~x__h8745 ;
  assign mask_out__h8922 = ~x__h8999 ;
  assign n_beat__h8068 = { 7'd0, stage3_ff_D_OUT[9:7] } ;
  assign x__h8745 = 16'd65535 << rg_processed[7:3] ;
  assign x__h8999 = 16'd65535 << rg_shift_amt[7:3] ;
  ...
  begin
	...
	rg_metadata <= `BSV_ASSIGNMENT_DELAY
	    1762';
  ...
  begin
    ...
    rg_eop = 1'h0;
    rg_metadata =
	1762';
  ...
  begin
	...
	$display("(%0d) stage2 %h len=%d",
		 v___1__h7921,
		 stage2_ff_D_OUT[2027:1772],
		 stage2_ff_D_OUT[1771:1762]);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont) $write("(%0d) stage3 cont ", v__h8395);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_stage3_cont)
