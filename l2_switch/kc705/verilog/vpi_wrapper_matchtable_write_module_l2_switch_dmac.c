 ...
 *     #include "vpi_wrapper_matchtable_write_module_l2_switch_dmac.h"
 *     void (*vlog_startup_routines[])() = { matchtable_write_module_l2_switch_dmac_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void matchtable_write_module_l2_switch_dmac(unsigned long long , char );

/* VPI wrapper function */
PLI_INT32 matchtable_write_module_l2_switch_dmac_calltf(PLI_BYTE8 *user_data)
{
  vpiHandle hCall;
  ...
  matchtable_write_module_l2_switch_dmac(arg_1, arg_2);
...
void matchtable_write_module_l2_switch_dmac_vpi_register()
{
  s_vpi_systf_data tf_data;
  
  /* Fill in registration data */
  tf_data.type = vpiSysTask;
  tf_data.tfname = "$imported_matchtable_write_module_l2_switch_dmac";
  tf_data.calltf = matchtable_write_module_l2_switch_dmac_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_matchtable_write_module_l2_switch_dmac";
