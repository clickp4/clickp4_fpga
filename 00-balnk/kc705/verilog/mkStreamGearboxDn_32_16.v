...
//
// On Thu Jun  1 22:44:20 CST 2017
//
...
module mkStreamGearboxDn_32_16(CLK,
			       RST_N,
  ...
  reg [355 : 0] fifoTxData_block0;
  wire [355 : 0] fifoTxData_block0_D_IN;
  ...
  reg [355 : 0] fifoTxData_block1;
  wire [355 : 0] fifoTxData_block1_D_IN;
  ...
  // submodule out_ff
  FIFO2 #(.width(32'd178), .guarded(32'd1)) out_ff(.RST(RST_N),
						   .CLK(CLK),
						   .D_IN(out_ff_D_IN),
						   .ENQ(out_ff_ENQ),
						   .DEQ(out_ff_DEQ),
  ...
  // submodule pipe_ff
  FIFO2 #(.width(32'd178), .guarded(32'd1)) pipe_ff(.RST(RST_N),
						    .CLK(CLK),
						    .D_IN(pipe_ff_D_IN),
						    .ENQ(pipe_ff_ENQ),
						    .DEQ(pipe_ff_DEQ),
  ...
  assign fifoTxData_block0_D_IN =
	     { in_ff_D_OUT[321:162],
	       ...
	       in_ff_D_OUT[161:34],
	       in_ff_D_OUT[17:1],
	       in_ff_D_OUT[33:18] == 16'd0 && in_ff_D_OUT[0] } ;
  ...
  assign out_ff_ENQ =
	     pipe_ff_EMPTY_N &&
	     (pipe_ff_D_OUT[17:2] == 16'd0 || out_ff_FULL_N) &&
	     pipe_ff_D_OUT[17:2] != 16'd0 ;
  ...
  assign pipe_ff_D_IN =
	     fifoTxData_read_block ?
	       ((!fifoTxData_elem1_status_1__read__3_EQ_fifoTxDa_ETC___d55 &&
		 fifoTxData_elem1_status_0__read__6_EQ_fifoTxDa_ETC___d57) ?
		  fifoTxData_block1[355:178] :
		  fifoTxData_block1[177:0]) :
	       ((!fifoTxData_elem0_status_1__read__4_EQ_fifoTxDa_ETC___d46 &&
		 fifoTxData_elem0_status_0__read__7_EQ_fifoTxDa_ETC___d48) ?
		  fifoTxData_block0[355:178] :
		  fifoTxData_block0[177:0]) ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        fifoTxData_block0 <= `BSV_ASSIGNMENT_DELAY 356'd0;
	fifoTxData_block0_status <= `BSV_ASSIGNMENT_DELAY 1'd0;
	fifoTxData_block1 <= `BSV_ASSIGNMENT_DELAY 356'd0;
  ...
  begin
    fifoTxData_block0 =
	356'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
...
endmodule  // mkStreamGearboxDn_32_16
