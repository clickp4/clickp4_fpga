...
int MainRequestmodule_if_if_equal_add_entry_cb (  struct PortalInternal *p, const ModuleIfIfEqualReqT key, const ModuleIfIfEqualRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_if_if_equal_add_entry ( key, val);
    return 0;
};
int MainRequestmodule_if_if_large_add_entry_cb (  struct PortalInternal *p, const ModuleIfIfLargeReqT key, const ModuleIfIfLargeRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_if_if_large_add_entry ( key, val);
    return 0;
};
int MainRequestmodule_if_if_small_add_entry_cb (  struct PortalInternal *p, const ModuleIfIfSmallReqT key, const ModuleIfIfSmallRspT val ) {
    (static_cast<MainRequestWrapper *>(p->parent))->module_if_if_small_add_entry ( key, val);
    return 0;
};
MainRequestCb MainRequest_cbTable = {
    ...
    MainRequestmodule_if_if_equal_add_entry_cb,
    MainRequestmodule_if_if_large_add_entry_cb,
    MainRequestmodule_if_if_small_add_entry_cb,
};
