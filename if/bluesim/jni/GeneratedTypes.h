...
typedef struct ModuleIfIfEqualReqT {
    uint8_t padding : 4;
    uint32_t click_id : 32;
} ModuleIfIfEqualReqT;
typedef struct ModuleIfIfEqualRspT {
    uint8_t _action : 1;
    uint8_t _state : 8;
    uint64_t _bitmap : 64;
} ModuleIfIfEqualRspT;
typedef struct ModuleIfIfLargeReqT {
    uint8_t padding : 4;
    uint32_t click_id : 32;
} ModuleIfIfLargeReqT;
typedef struct ModuleIfIfLargeRspT {
    uint8_t _action : 1;
    uint8_t _state : 8;
    uint64_t _bitmap : 64;
} ModuleIfIfLargeRspT;
typedef struct ModuleIfIfSmallReqT {
    uint8_t padding : 4;
    uint32_t click_id : 32;
} ModuleIfIfSmallReqT;
typedef struct ModuleIfIfSmallRspT {
    uint8_t _action : 1;
    uint8_t _state : 8;
    uint64_t _bitmap : 64;
} ModuleIfIfSmallRspT;
...
} MainRequest_module_if_if_equal_add_entryData;
typedef struct {
    ModuleIfIfLargeReqT key;
    ModuleIfIfLargeRspT val;
} MainRequest_module_if_if_large_add_entryData;
typedef struct {
    ModuleIfIfSmallReqT key;
    ModuleIfIfSmallRspT val;
} MainRequest_module_if_if_small_add_entryData;
typedef union {
    ...
    MainRequest_module_if_if_equal_add_entryData module_if_if_equal_add_entry;
    MainRequest_module_if_if_large_add_entryData module_if_if_large_add_entry;
    MainRequest_module_if_if_small_add_entryData module_if_if_small_add_entry;
} MainRequestData;
...
typedef struct {
    ...
    int (*module_if_if_equal_add_entry) (  struct PortalInternal *p, const ModuleIfIfEqualReqT key, const ModuleIfIfEqualRspT val );
    int (*module_if_if_large_add_entry) (  struct PortalInternal *p, const ModuleIfIfLargeReqT key, const ModuleIfIfLargeRspT val );
    int (*module_if_if_small_add_entry) (  struct PortalInternal *p, const ModuleIfIfSmallReqT key, const ModuleIfIfSmallRspT val );
} MainRequestCb;
