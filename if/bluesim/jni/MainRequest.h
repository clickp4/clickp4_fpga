...
public:
    ...
    int module_if_if_equal_add_entry ( const ModuleIfIfEqualReqT key, const ModuleIfIfEqualRspT val ) { return cb->module_if_if_equal_add_entry (&pint, key, val); };
    int module_if_if_large_add_entry ( const ModuleIfIfLargeReqT key, const ModuleIfIfLargeRspT val ) { return cb->module_if_if_large_add_entry (&pint, key, val); };
    int module_if_if_small_add_entry ( const ModuleIfIfSmallReqT key, const ModuleIfIfSmallRspT val ) { return cb->module_if_if_small_add_entry (&pint, key, val); };
};
...
public:
    ...
    virtual void module_if_if_equal_add_entry ( const ModuleIfIfEqualReqT key, const ModuleIfIfEqualRspT val ) = 0;
    virtual void module_if_if_large_add_entry ( const ModuleIfIfLargeReqT key, const ModuleIfIfLargeRspT val ) = 0;
    virtual void module_if_if_small_add_entry ( const ModuleIfIfSmallReqT key, const ModuleIfIfSmallRspT val ) = 0;
};
