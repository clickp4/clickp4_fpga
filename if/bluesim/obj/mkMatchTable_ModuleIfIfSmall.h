...
/* Generation options: */
#ifndef __mkMatchTable_ModuleIfIfSmall_h__
#define __mkMatchTable_ModuleIfIfSmall_h__
...
/* Class declaration for the mkMatchTable_ModuleIfIfSmall module */
class MOD_mkMatchTable_ModuleIfIfSmall : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkMatchTable_ModuleIfIfSmall(tSimStateHdl simHdl,
				   char const *name,
				   Module *parent,
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkMatchTable_ModuleIfIfSmall &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkMatchTable_ModuleIfIfSmall &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkMatchTable_ModuleIfIfSmall &backing);
};

#endif /* ifndef __mkMatchTable_ModuleIfIfSmall_h__ */
