...
/* Generation options: */
#ifndef __mkMatchTable_ModuleIfIfLarge_h__
#define __mkMatchTable_ModuleIfIfLarge_h__
...
/* Class declaration for the mkMatchTable_ModuleIfIfLarge module */
class MOD_mkMatchTable_ModuleIfIfLarge : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkMatchTable_ModuleIfIfLarge(tSimStateHdl simHdl,
				   char const *name,
				   Module *parent,
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkMatchTable_ModuleIfIfLarge &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkMatchTable_ModuleIfIfLarge &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkMatchTable_ModuleIfIfLarge &backing);
};

#endif /* ifndef __mkMatchTable_ModuleIfIfLarge_h__ */
